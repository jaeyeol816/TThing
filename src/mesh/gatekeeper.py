...
TIER_CLAUSES: dict[Tier, str] = {
    ...
    Tier.INTERNAL: (
        "입력은 식별자가 비식별 기호(placeholder)로 치환된 텍스트입니다. "
        "<PROJ_1>, <PERSON_2>, <SYS_1>, <DATE_1>, <VER_1> 같은 기호는 "
        "**원형 그대로** 답변에 사용하십시오 — 실제 이름을 추측하거나 일반 단어로 바꾸지 마십시오. "
        "기호를 그대로 쓰면 신뢰 구역에서 자동으로 실제 이름으로 되돌려집니다."
    ),
    Tier.OPEN: "",
}
