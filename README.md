...
> **M**issing **I**n **A**ction — 담당자는 회의 중이거나 휴가다. 그래도 그 사람의 지식은 필요하다.
> **But AI got you** — 그 사람 앞에 세워 둔 대리 에이전트가 답한다.
>
> 질문을 사람이 아니라 에이전트에게 보낸다. 기밀 자료는 신뢰 구역 안에서만 읽히고,
> 외부 AI에는 **데이터가 아니라 문제의 구조만** 나간다.
